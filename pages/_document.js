  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Break echo chambers with AI-powered counternarrative discovery. Find diverse perspectives fro Farcater, TwitX and news sources. Mint NFT Insigh Toens and earn ewards!"
        /
        <meta
          name="keywords"
