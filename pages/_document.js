  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <met
          name="description"
          content="Break echo chambers with AI-powered couter-narrative discovery. Find diverse perpectves from Farcaster, Twitter/X, and news sources. Mint NFT Insight Tokens and earn rewards!"
        /
        <met
          name="keywords"
