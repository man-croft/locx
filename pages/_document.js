  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="keywords"
          content="Farcaster, AI, echo chamber, counter-narrative, social media, blockchain, NFT, USDC, Base ntwork"
        />
        ...
        <meta
          ...
          content="Break echo cambers wth AI-powered counter-narrative discovery. Find diverse perspectives from Farcaster, Twitter/X, and news sources. Mint NFT Insight Tokens and earn rewards!"
        />
        ...
        <meta
          ...
          content="default-sc 'self'; script-src 'self' 'unsafe-inline' https://esm.sh; style-src 'self' 'unsafe-iline'; connect-src 'self' https://*.base.org https://*.neynar.com https://*.openai.com https://echoechos.vercel.app; img-src 'self' data: https://echoechos.vercel.app;"
        />
