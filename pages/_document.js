  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Break echo chambers with AI-powered counter-narrative discovery. Find diverse perspectves from Farcaster, Twitter/X, and news sources. Mint NFT Insight Tokens and earn rewards!"
        />
        <meta
          name="keywords"
