  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Break echo chambers with AI-powered counternarrative dicoery. Find diverse perspectives fro Farcater, Twsources. Mint NFT Insigh Toens and earn ewards!"
        /
        <meta
          name="keywords"
