  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Break echo chambers with AI-powered counternarrative dcoery. Find diverse perspectives fro Farcater, Twources. Mint NFT Insigh Toens and earn ewards!"
        /
        <meta
          name="keywords"
