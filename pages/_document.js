  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Break echo chambers with AI-powered counternarrative dicoery. Find diverse perspectives fro Farcater, Twi sources. Mint NFT Insigh Toens and earn ewards!"
        /
        <meta
          name="keywords"
