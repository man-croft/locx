  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Break echo chambers with AI-powered counternarrative discovery. Find diverse perspectives fro Farcater, Twiter/X, and news sources. Mint NFT Insigh Toens and earn rewards!"
        /
        <meta
          name="keywords"
