  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="Break echo chambers with AI-powered counternarrative discovery. Find diverse perspectives fro Farcater, Twit ad news sources. Mint NFT Insigh Toens and earn ewards!"
        /
        <meta
          name="keywords"
